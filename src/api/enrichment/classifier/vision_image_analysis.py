...
class AzureAIVisionModel:
    ...
    async def async_visual_features(
        self, image_base64: str, visual_features: list[VisualFeatures]
    ) -> list[str]:
        ...
        response = await loop.run_in_executor(
            self._executor, self._model.analyze, image_bytes, visual_features
        )
